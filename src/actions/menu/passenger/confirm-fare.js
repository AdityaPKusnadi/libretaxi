...
export default class PassengerConfirmFare extends Action {
  ...
  _submitOrder() {
    ...
    return new PromiseResponse({
      promise: calculateFareAsync(origin, destination),
      cb: (fare) => {
        ...
        const groupLines = [
          ...
          `\u{1F4CF} Est. Distance: ${fare.distanceKm} km`,
          `\u{1F4B0} Est. Fare: ${fare.currencySymbol}${fare.totalFare}`,
          `\u{1F697} Vehicle: ${this.user.state.requestedVehicleType || 'car'}`,
          '',
          formatDate(),
        ];
